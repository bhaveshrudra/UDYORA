...
export const EvidenceAuditModal: React.FC<EvidenceAuditModalProps> = ({
 ...
 isOpen={isOpen}
 onClose={onClose}
 title={t('modal.evidenceTitle') ||'GROUND-TRUTH EVIDENCE AUDIT'}
 subtitle={t('modal.evidenceSubtitle') ||'Verified parameters against LGD 2026.02 & Census administrative databases'}
