...
export const Header: React.FC<HeaderProps> = ({
 ...
 return (
 <>
 <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-200/90 shadow-2xs h-16 sm:h-[68px] flex items-center select-none transition-colors duration-200">
